                            ...
                            <div class="col">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h1 class="h4 text-gray-900 mb-4">Deposit $USDT(Tron20) for BNB </h1>
                                    </div>
                                    ...
                                    <form class="user" action="deposit-logic.php" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="txid" class="form-control form-control-user"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bnb" value="BNB"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="uploadfile" id="actual-btn" hidden />
