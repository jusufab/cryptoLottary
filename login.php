...
<div class="formDiv">
    ...
    <div class="alert <?php echo $_SESSION['alert-class']; ?> " style=" color:red">
        <?php
    ...
    <?php endif; ?>
    <?php
    if (isset($_SESSION['passwordName'])) : ?>
    <div class="alert <?php echo $_SESSION['alert-class']; ?> " style=" color:red">
        <?php
            echo $_SESSION['passwordName'];

            unset($_SESSION['passwordName']);
    ...
    <div class="alert <?php echo $_SESSION['alert-class']; ?> " style=" color:red">
        <?php
            echo $_SESSION['wrong1'];

            unset($_SESSION['wrong1']);
    ...
    <form action="authController.php" method="POST">
        ...
        <button type="submit" name="submit-log" class="btn">Login</button>
