                            ...
                            <div class="col">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h1 class="h4 text-gray-900 mb-4">Deposit $USDT(Tron20) for ETH </h1>
                                    </div>
                                    ...
                                    <form class="user" action="deposit-logic.php" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="txidEther" class="form-control form-control-user"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="uploadfileeth" id="actual-btn" hidden />
                                        ...
                                        <input type="submit" value="Deposite" name="submit2"
